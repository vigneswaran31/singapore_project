...
<%--<%@ Page Language="C#" MasterPageFile="~/Areas/Admin/Views/Shared/_Layout.cshtml" Inherits="System.Web.Mvc.ViewPage<dynamic" %>--%>
        ...
        <table width="750" border="0" cellpadding="3" cellspacing="0">
            <tr>
                ...
                <td valign="top" id="content">
                    ...
                    <br>
                    <p>
                        This <strong>Administration Console</strong> is a web based control panel that lets you 
                    ...
                    <table cellpadding="10" cellspacing="1" border="0" width="100%" bgcolor="#A5B6DE">
                        <tr bgcolor="#f5f5f5">
                            <td valign="top">
                                <img src="../images/setting.gif" border="0" alt="Configuration" /></td>
                            <td valign="top">
                                <b>Configuration</b>
                                <br>
                        ...
                        <tr bgcolor="#ffffff">
                            <td valign="top">
                                <img src="../images/find.gif" border="0" alt="Bad word filter" /></td>
                            <td valign="top">
                        ...
                        <tr bgcolor="#f5f5f5">
                            <td valign="top">
                                <img src="../images/icon_ban_allow.gif" border="0" alt="Deny & Allow IP" /></td>
                            <td valign="top">
                                <b>Deny & Allow IP</b><br>
                        ...
                        <tr bgcolor="#ffffff">
                            <td valign="top">
                                <img src="../images/archive.gif" border="0" alt="View/delete/export Chat Log" /></td>
                            <td valign="top">
                                <b>View/delete/export Chat Log </b>
                                <br>
