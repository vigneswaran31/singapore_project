...
function CreateOldMenuImplementation()
{
	...
	function MenuClass_CreateFrame(menuitem)
	{
		...
		for(var i=0;i<menuitem.items.length;i++)
		{
			...
			var tablehtml="<table border=0 cellspacing=0 cellpadding=0 style='height:20px;width:100%;overflow:visible;'>";
			...
			if(childitem.hotkey)
			{
				...
				tablehtml+="<td align='left' style='width:43px;padding-left:1px;padding-top:4px;' rem-disabled=true nowrap>"+childitem.hotkey+"</td>";
			}
			else
			{
				tablehtml+="</td><td colspan=2 nowrap=nowrap align='left' style='width:"+const_menuwidth+";padding-left:4px;padding-top:3px;padding-right:4px;";
				if(childitem.color)
					tablehtml+="color:"+childitem.color;
				tablehtml+="'>"+childitem.html+"</td>";
			}
			...
			if(true)
			{
				tablehtml+="<td align='right' style='width:20px;padding-top:3px;padding-right:2px;'><span style='width:20px;";
