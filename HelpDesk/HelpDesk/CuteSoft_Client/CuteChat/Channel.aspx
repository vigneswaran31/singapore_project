				...
				<td style="border: #A5B6DE 1px solid; width: 100%;" valign="top">
					...
					<div style="clear:both;border-top: #A5B6DE 1px solid;border-bottom: #A5B6DE 1px solid;width:100%;background-color: #ffffff;">
						<table style="width: 100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td valign="top">
									<textarea id="inputBox" style="overflow:hidden;width:100%;height:56px;background-color: #ffffff;border:0px solid #ffffff;outline: none;resize:none;"></textarea>
								</td>
								<td style="background-color: #ffffff; text-align:right; width:110px;"
					...
					<table style="width: 100%; height:20px;" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td style="color:#A5B6DE; font-size:12px;" align="right">Press Shift+Enter to go to the next line.
							</td>
						</tr>
					</table>
				</td>
