				...
				<tr>
					...
					<td align="left" id="content">
						...
						<div align="left" style="PADDING-RIGHT:5px;PADDING-LEFT:5px;PADDING-BOTTOM:5px;PADDING-TOP:0px">
							Bad Word:
							<asp:TextBox id="tb_new_badword" runat="server" Width="300"></asp:TextBox>
							Type :
							...
							<asp:DataGrid DataKeyField="RuleId" OnDeleteCommand="DataGrid1_DeleteCommand" OnUpdateCommand="DataGrid1_UpdateCommand"
								...
								Width="700" Font-Name="Verdana" Font-Size="8pt" BorderWidth="1px" BackColor="White" CellPadding="2"
								CellSpacing="0">
							...
							<br>
							<br>
							<div align="left" style="padding-right:5px; padding-left:5px; padding-bottom:0px; width:650px; padding-top:0px">
