							...
							<tr>
								<td class="boxArea">
									<table cellSpacing="0" cellPadding="5" width="750" border="0">
										<tr bgcolor="#f5f5f5">
											<td>Show Video Chat Button</td>
											<td><asp:DropDownList ConfigName="ShowVideoButton" Runat="server" Width="200" ID="Dropdownlist3">
                                            ...
                                            <td>
                                                <a href="#" class="tooltip">
                                                    ...
                                                    <span>
                                                        ...
                                                        <strong>Flash Vedio Chat Server</strong><br />
                                                        <%=FlashChatServer%>
                                                    </span>
                                                </a>
                                            </td>
										...
										<tr bgcolor="#f5f5f5">
											<td>Global Announcement</td>
											<td><asp:TextBox TextMode="MultiLine" ConfigName="Announcement" Runat="server" Width="200" ID="Textbox1"></asp:TextBox></td>
                                            <td>
                                                <a href="#" class="tooltip">
                                                    <img src="../images/help.png">
                                                    <span>
                                                        <img class="callout" src="../images/callout.gif" />
                                                        <strong>Global Announcement</strong><br />
                                                        <%=GlobalAnnouncement%>
                                                    </span>
                                                </a>
                                            </td>
										...
										<tr bgcolor="#ffffff">
											...
											<td><asp:TextBox ConfigName="ChannelOnlineExpires" Runat="server" Width="200" ID="Textbox3" NAME="Textbox1"></asp:TextBox></td>
											<td>
                                                <a href="#" class="tooltip">
                                                    <img src="../images/help.png">
                                                    <span>
                                                        <img class="callout" src="../images/callout.gif" />
                                                        <strong>Network Error Timeout</strong><br />
                                                        <%=NetworkErrorTimeout%>
                                                    </span>
                                                </a>
                                            </td>
										...
										<tr bgcolor="#f5f5f5">
											<td>Flood Control</td>
											<td><asp:TextBox ConfigName="FloodControlCount" Runat="server" Width="50" ID="Textbox4"></asp:TextBox>&nbsp;/&nbsp;<asp:TextBox ConfigName="FloodControlDelay" Runat="server" Width="50" ID="Textbox5"></asp:TextBox></td>
											<td>
                                                <a href="#" class="tooltip">
                                                    <img src="../images/help.png">
                                                    <span>
                                                        <img class="callout" src="../images/callout.gif" />
                                                        <strong>Flood Control</strong><br />
                                                        <%=FloodControl%>
                                                    </span>
                                                </a>
                                            </td>
										...
										<tr bgcolor="#ffffff">
											...
											<td>
                                                <a href="#" class="tooltip">
                                                    ...
                                                    <span>
                                                        <img class="callout" src="../images/callout.gif" />
                                                        <strong>Max length of a single word</strong><br />
                                                        <%=MaxLengthperWord%>
                                                    </span>
                                                </a>
                                            </td>
										...
										<tr bgcolor="#f5f5f5">
											...
											<td>
                                                <a href="#" class="tooltip">
                                                    ...
                                                    <span>
                                                        <img class="callout" src="../images/callout.gif" />
                                                        <strongMax length of a message</strong><br />
                                                        <%=MaxLengthperMessage%>
                                                    </span>
                                                </a>
                                            </td>
										...
										<tr bgcolor="#f5f5f5">
											<td>Show Join/Leave system message</td>
