						...
						<table cellspacing="1" cellpadding="3" border="0" class="box">
							...
							<tr>
								<td valign=top class="boxArea">	
									<table cellSpacing="0" cellPadding="6" width="750" border="0">
										<tr bgcolor="#f5f5f5">
										...
										<tr bgcolor="#ffffff">
											<td>File Upload Filters (Chat Room)</td>
											<td><asp:TextBox ConfigName="GlobalSendFileType" Runat="server" Width="150" ID="Textbox6"></asp:TextBox></td>
											<td style="word-break:break-all;word-wrap:break-word;font-size:12px;">
										...
										<tr bgcolor="#ffffff">
											<td>File Upload Filters (Messenger)</td>
											<td><asp:TextBox ConfigName="MessengerSendFileType" Runat="server" Width="150" ID="Textbox2"></asp:TextBox></td>
											<td style="word-break:break-all;word-wrap:break-word;font-size:12px;">
