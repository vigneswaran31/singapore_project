...
void Button_Confirm_Init(object sender,EventArgs args)
{
    ...
    if (msg == null) msg = "Are you sure you want to delete this moderator?";
			...
			<div Style="margin-bottom: 55px; height: 230px; padding: 20px 0 5px 10px;">
				<p>
					<asp:DataGrid id="DataGrid1" runat="server" BorderColor="#99A6C8" AutoGenerateColumns="False"
						DataKeyField="UserId" Width="98%" BorderWidth="1px"
						BackColor="White" CellPadding="6" CellSpacing="0">
						...
						<Columns>
							<asp:BoundColumn DataField="DisplayName" ItemStyle-Width="70%" HeaderText="[[DisplayName]]"></asp:BoundColumn>
							<asp:TemplateColumn>
								<ItemTemplate>
				...
				<table cellpadding="3">
					<tr>
						<td><b>User Name:</b>&nbsp;&nbsp; </td>
						<td><asp:TextBox Runat="server" ID="TextBoxUsername" Width="250" /></td>
