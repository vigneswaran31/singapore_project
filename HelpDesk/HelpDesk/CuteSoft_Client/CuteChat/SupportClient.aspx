    ...
    <script runat="server">
        ...
        override protected void OnInit(EventArgs args)
        {
            ...
            if (Request.IsAuthenticated) {
                displayname = HelpDesk.Classes.SiteUtility.GetCurrentUser().Name;
                displayemail = HelpDesk.Classes.SiteUtility.GetCurrentUser().Email;
            }
                ...
                <td class="informationBox">
                    ...
                    <table border="0" cellspacing="0" cellpadding="4" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="input_email" value='<%=displayemail%>' class="inputwidth" />
                            </td>
                        </tr>
                        <%
